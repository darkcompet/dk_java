...
/**
 * This maps int vs int.
 * We make this for Java (from Android).
 */
public class DkIntIntArrayMap implements Cloneable {
	private int size;
	private int[] keys;
	private int[] values;
	 ...
	 */
	public DkIntIntArrayMap(int initialCapacity) {
		if (initialCapacity <= 0) {
			keys = MyEmptyArray.INT;
			values = MyEmptyArray.INT;
		}
		else {
	...
	public int get(int key, int valueIfKeyNotFound) {
		...
		return index < 0 ? valueIfKeyNotFound : (int) values[index];
	}

...
public class MyFinder {
	 ...
	 */
	@NonNull
	Map<Class<? extends Annotation>, List<Field>> findFields(Class clazz, Iterable<Class<? extends Annotation>> annotations,
	 ...
	 */
	@NonNull
	Map<Class<? extends Annotation>, List<Method>> findMethods(Class clazz, Iterable<Class<? extends Annotation>> annotations,
															   boolean upSuper, String[] searchPackages) {
	 ...
	 */
	private static <T> void mergeWithSuperResult(Iterable<Class<? extends Annotation>> annotations,
